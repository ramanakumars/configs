return {
	...
	dependencies = {
		...
		{ "williamboman/mason.nvim", opts = {}, version = "1.x" },
	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("<leader>ri", require("fzf-lua").lsp_implementations, "[G]oto [I]mplementation")
				...
				map("<leader>W", require("fzf-lua").lsp_live_workspace_symbols, "Open Workspace Symbols")

				-- Jump to the type of the word under your cursor.
				--  Useful when you're not sure what type a variable is and you want to see
				--  the definition of its *type*, not where it was *defined*.
				map("<leader>rt", require("fzf-lua").lsp_typedefs, "[G]oto [T]ype Definition")
